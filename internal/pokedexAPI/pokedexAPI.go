...
func UnmarshalLocations(body []byte) (LocationsResponse, error) {
...
func UnmarshalLocation(body []byte) (SpecificLocationResponse, error) {
...
func UnmarshalBody(body []byte, v interface{}) (interface{}, error) {
